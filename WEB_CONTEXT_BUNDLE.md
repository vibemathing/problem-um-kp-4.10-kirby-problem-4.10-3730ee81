...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.10-kirby-problem-4.10-3730ee81-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.10"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.10-kirby-problem-4.10-3730ee81-v1",
      "problem_contract_sha256": "689e68fc1628037c97f1e2de07015eb878877e6708dd811710924cb7bcc51eda",
      "problem_id": "problem:um-kp-4.10-kirby-problem-4.10-3730ee81",
      "route_id": "route:um-kp-4.10-kirby-problem-4.10-3730ee81-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.10-kirby-problem-4.10-3730ee81-source-fidelity-01",
      "graph_id": "graph:um-kp-4.10-kirby-problem-4.10-3730ee81-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.10-kirby-problem-4.10-3730ee81-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.10-kirby-problem-4.10-3730ee81-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Is every homotopy $B^{4}$ with boundary $S^{3}$ obtained by performing a Gluck twist on some knotted 2-sphere in $B^{4}$? (b) Suppose a homotopy 4-ball X is obtained by performing a Gluck twist on a knotted 2-sphere in $B^{4}$. Is $X \\times I$ necessarily diffeomorphic to $B^{5}$?"
          },
          "statement_sha256": "719e4ac9de2d0a1c265d52bf7703c110b8a13bd403e88ae7eab7e750f25eca96"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.10-kirby-problem-4.10-3730ee81-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.10-kirby-problem-4.10-3730ee81-root",
      "route_id": "route:um-kp-4.10-kirby-problem-4.10-3730ee81-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.10-047edbe96d93",
        "url": "https://www.unsolvedmath.com/problems/KP-4.10"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
